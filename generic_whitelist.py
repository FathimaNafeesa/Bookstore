...
rawlog = safe_json_parse(sw_context.inputs.get("rawlog"))  # lowercase variant
udmEvent = safe_json_parse(sw_context.inputs.get("udmEvent"))

# Use whichever log is available
log_data = rawLog or rawlog

# Alert name (could be "alertName" or "name")
alert_name = sw_context.inputs.get("alertName") or sw_context.inputs.get("name")

# =============================================================================
# 2. CUSTOMER-PROVIDED WHITELIST DATA (LISTS)
# =============================================================================

whitelist_alert_names = sw_context.inputs.get("whitelist_alert_names", [])
whitelist_hashes = sw_context.inputs.get("whitelist_hashes", [])
whitelist_ips = sw_context.inputs.get("whitelist_ips", [])
whitelist_categories = sw_context.inputs.get("whitelist_categories", [])
whitelist_udm_event_types = sw_context.inputs.get("whitelist_udm_event_types", [])
whitelist_descriptions = sw_context.inputs.get("whitelist_descriptions", [])
...
abuse_api_key = sw_context.inputs.get("abuse_key")
...
custom_rules = sw_context.inputs.get("custom_rules", [])
